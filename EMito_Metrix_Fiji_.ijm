...
print("Checking FIJI plugin configuration----------------------------- OK\n");
	...
	if ((parameters1 == "No") || (parameters2 == "No") || (parameters3 == "No") || (parameters4 == "No") || (parameters5 == "No") || (parameters6 == "No") || (parameters7 == "No") || (parameters8 == "No") || (parameters9 == "No") || (parameters10 == "No") || (parameters11 == "No")){
	...
	if (error_configuration == 0){
		...
		environment_choice = newArray("Windows");
		...
		if ((error_python_file == 0) && (error_cellpose == 0)){
			...
			if ((error_input_tree == 0) && (error_output_tree == 0)){
				...
				cellpose_model = newArray("nuclei","cyto","cyto2","Custom model");
					...
					if (ml_choice == "Yes"){
						...
						if (default_metrics == "True"){
							...
							if (default_prediction == "True"){
								if (explain == "False"){
									if (string_arg.length == 3){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2]);
									} else if (string_arg.length == 4){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3]);
									} else if (string_arg.length == 5){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4]);
									} else if (string_arg.length == 6){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5]);
									} else if (string_arg.length == 7){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6]);
									} else if (string_arg.length == 8){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7]);
									} else if (string_arg.length == 9){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-modelsr", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8]);
									} else if (string_arg.length == 10){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9]);
									} else if (string_arg.length == 11){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10]);
									} else if (string_arg.length == 12){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11]);
									} else if (string_arg.length == 13){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12]);
									} else if (string_arg.length == 14){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13]);
									} else if (string_arg.length == 15){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], string_arg[14]);
									} else if (string_arg.length == 16){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], string_arg[14], string_arg[15]);
									} else if (string_arg.length == 17){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], string_arg[14], string_arg[15], string_arg[16]);
									} else if (string_arg.length == 18){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], string_arg[14], string_arg[15], string_arg[16], string_arg[17]);
									} else if (string_arg.length == 19){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], string_arg[14], string_arg[15], string_arg[16], string_arg[17], string_arg[18]);
									...
									if (string_arg.length == 3){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], "--explain", "--explain");
									} else if (string_arg.length == 4){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--explain", "--explain");
									} else if (string_arg.length == 5){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--explain", "--explain");
									} else if (string_arg.length == 6){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--explain", "--explain");
									} else if (string_arg.length == 7){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--explain", "--explain");
									} else if (string_arg.length == 8){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--explain", "--explain");
									} else if (string_arg.length == 9){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-modelsr", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--explain", "--explain");
									} else if (string_arg.length == 10){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--explain", "--explain");
									} else if (string_arg.length == 11){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--explain", "--explain");
									} else if (string_arg.length == 12){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], "--explain", "--explain");
									} else if (string_arg.length == 13){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], "--explain", "--explain");
									} else if (string_arg.length == 14){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], "--explain", "--explain");
									} else if (string_arg.length == 15){
										exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, "--all-models", string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], string_arg[14], "--explain", "--explain");
									} else if (string_arg.length == 16){
								...
								if (string_arg2.length == 1){
									if (explain == "False"){
										...
										if (string_arg.length == 3){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], "--explain", "--explain");
										} else if (string_arg.length == 4){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--explain", "--explain");
										} else if (string_arg.length == 5){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--explain", "--explain");
										} else if (string_arg.length == 6){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--explain", "--explain");
										} else if (string_arg.length == 7){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--explain", "--explain");
										} else if (string_arg.length == 8){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--explain", "--explain");
										} else if (string_arg.length == 9){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--explain", "--explain");
										} else if (string_arg.length == 10){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--explain", "--explain");
										} else if (string_arg.length == 11){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--explain", "--explain");
										} else if (string_arg.length == 12){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], "--explain", "--explain");
										} else if (string_arg.length == 13){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], "--explain", "--explain");
										} else if (string_arg.length == 14){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], "--explain", "--explain");
										} else if (string_arg.length == 15){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], string_arg[14], "--explain", "--explain");
										} else if (string_arg.length == 16){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], string_arg[14], string_arg[15], "--explain", "--explain");
										} else if (string_arg.length == 17){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], string_arg[14], string_arg[15], string_arg[16], "--explain", "--explain");
									...
									if (explain == "False"){
										...
										if (string_arg.length == 3){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], "--explain", "--explain");
										} else if (string_arg.length == 4){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--explain", "--explain");
										} else if (string_arg.length == 5){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--explain", "--explain");
										} else if (string_arg.length == 6){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--explain", "--explain");
										} else if (string_arg.length == 7){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--explain", "--explain");
										} else if (string_arg.length == 8){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--explain", "--explain");
										} else if (string_arg.length == 9){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--explain", "--explain");
										} else if (string_arg.length == 10){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--explain", "--explain");
										} else if (string_arg.length == 11){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--explain", "--explain");
										} else if (string_arg.length == 12){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], "--explain", "--explain");
										} else if (string_arg.length == 13){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], "--explain", "--explain");
										} else if (string_arg.length == 14){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], "--explain", "--explain");
										} else if (string_arg.length == 15){
									...
									if (explain == "False"){
										...
										if (string_arg.length == 3){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], "--explain", "--explain");
										} else if (string_arg.length == 4){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--explain", "--explain");
										} else if (string_arg.length == 5){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--explain", "--explain");
										} else if (string_arg.length == 6){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--explain", "--explain");
										} else if (string_arg.length == 7){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--explain", "--explain");
										} else if (string_arg.length == 8){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--explain", "--explain");
										} else if (string_arg.length == 9){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--explain", "--explain");
										} else if (string_arg.length == 10){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--explain", "--explain");
										} else if (string_arg.length == 11){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--explain", "--explain");
										} else if (string_arg.length == 12){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], "--explain", "--explain");
										} else if (string_arg.length == 13){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], "--explain", "--explain");
										} else if (string_arg.length == 14){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], "--explain", "--explain");
										} else if (string_arg.length == 15){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], string_arg[14], "--explain", "--explain");
									...
									if (explain == "False"){
										...
										if (string_arg.length == 3){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], "--explain", "--explain");
										} else if (string_arg.length == 4){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--explain", "--explain");
										} else if (string_arg.length == 5){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--explain", "--explain");
										} else if (string_arg.length == 6){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--explain", "--explain");
										} else if (string_arg.length == 7){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--explain", "--explain");
										} else if (string_arg.length == 8){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--explain", "--explain");
										} else if (string_arg.length == 9){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--explain", "--explain");
										} else if (string_arg.length == 10){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--explain", "--explain");
										} else if (string_arg.length == 11){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--explain", "--explain");
										} else if (string_arg.length == 12){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], "--explain", "--explain");
										} else if (string_arg.length == 13){
								...
								if (no_save_P == "True"){
									if (string_arg2.length == 1){
										if (explain == "False"){
											...
											if (string_arg.length == 3){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], "--no-draw", "--no-save", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 4){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--no-draw", "--no-save", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 5){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--no-draw", "--no-save", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 6){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--no-draw", "--no-save", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 7){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--no-draw", "--no-save", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 8){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--no-draw", "--no-save", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 9){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--no-draw", "--no-save", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 10){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--no-draw", "--no-save", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 11){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--no-draw", "--no-save", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 12){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], "--no-draw", "--no-save", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 13){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], "--no-draw", "--no-save", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 14){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], "--no-draw", "--no-save", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 15){
										...
										if (explain == "False"){
											...
											if (string_arg.length == 3){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 4){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 5){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 6){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 7){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 8){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 9){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 10){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 11){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 12){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 13){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 14){
										...
										if (explain == "False"){
											...
											if (string_arg.length == 3){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 4){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 5){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 6){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 7){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 8){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 9){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 10){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 11){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 12){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 13){
										...
										if (explain == "False"){
											...
											if (string_arg.length == 3){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 4){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 5){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 6){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 7){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 8){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 9){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 10){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 11){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--no-draw", "--no-save", "--explain", "--explain");
											} else if (string_arg.length == 12){
									...
									if (string_arg2.length == 1){
										if (explain == "False"){
											...
											if (string_arg.length == 3){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 4){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 5){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 6){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 7){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 8){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 9){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 10){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 11){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 12){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 13){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 14){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 15){
										...
										if (explain == "False"){
											...
											if (string_arg.length == 3){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], "--no-draw", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 4){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--no-draw", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 5){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--no-draw", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 6){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--no-draw", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 7){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--no-draw", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 8){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--no-draw", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 9){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--no-draw", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 10){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--no-draw", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 11){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--no-draw", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 12){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], "--no-draw", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 13){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], "--no-draw", "--explain", "--explain", "--explain");
											} else if (string_arg.length == 14){
										...
										if (explain == "False"){
											...
											if (string_arg.length == 3){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 4){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 5){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 6){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 7){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 8){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 9){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 10){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 11){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 12){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 13){
										...
										if (explain == "False"){
											...
											if (string_arg.length == 3){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 4){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 5){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 6){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 7){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 8){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 9){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 10){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 11){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 12){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 13){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], "--no-draw", "--explain", "--explain");
											} else if (string_arg.length == 14){
												exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], "--no-draw", "--explain", "--explain");
								...
								if (string_arg2.length == 1){
									if (explain == "False"){
										...
										if (string_arg.length == 3){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 4){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 5){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 6){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 7){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 8){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 9){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 10){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 11){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 12){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 13){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 14){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 15){
									...
									if (explain == "False"){
										...
										if (string_arg.length == 3){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 4){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 5){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 6){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 7){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 8){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 9){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 10){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 11){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 12){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 13){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 14){
									...
									if (explain == "False"){
										...
										if (string_arg.length == 3){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 4){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 5){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 6){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 7){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 8){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 9){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 10){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 11){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 12){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 13){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 14){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], "--no-save", "--explain", "--explain");
										} else if (string_arg.length == 15){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], string_arg[11], string_arg[12], string_arg[13], string_arg[14], "--no-save", "--explain", "--explain");
									...
									if (explain == "False"){
										...
										if (string_arg.length == 3){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], "--no-save", "--explain", "--explain", "--explain");
										} else if (string_arg.length == 4){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], "--no-save", "--explain", "--explain", "--explain");
										} else if (string_arg.length == 5){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], "--no-save", "--explain", "--explain", "--explain");
										} else if (string_arg.length == 6){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], "--no-save", "--explain", "--explain", "--explain");
										} else if (string_arg.length == 7){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], "--no-save", "--explain", "--explain", "--explain");
										} else if (string_arg.length == 8){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], "--no-save", "--explain", "--explain", "--explain");
										} else if (string_arg.length == 9){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], "--no-save", "--explain", "--explain", "--explain");
										} else if (string_arg.length == 10){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], "--no-save", "--explain", "--explain", "--explain");
										} else if (string_arg.length == 11){
											exec(dir_python_exe, "-W", "ignore", dir_python, "-i", dir_input, "-o", dir_prediction, string_arg2[0], string_arg2[1], string_arg2[2], string_arg2[3], string_arg[0], string_arg[1], string_arg[2], string_arg[3], string_arg[4], string_arg[5], string_arg[6], string_arg[7], string_arg[8], string_arg[9], string_arg[10], "--no-save", "--explain", "--explain", "--explain");
										} else if (string_arg.length == 12){
